...
namespace CompuSportDAL
{
    public class SprintAthleteEdit
    {
        ...
        public DataTable GetPrimaryAthletsCoachName(int CustomerID)
        {
            DataSet ds = new DataSet();
            using (SqlConnection conn = new SqlConnection(ConnectionString))
            {
                using (SqlCommand cmd = conn.CreateCommand())
                {
                    ...
                    cmd.CommandText = "GetPrimaryAthletsCoachName";
                    cmd.Connection = conn;
                    SqlDataAdapter da = new SqlDataAdapter(cmd);
                    da.Fill(ds);
                    return ds.Tables[0];
        ...
        public DataTable GetAllSprindSDVariable()
        {
            DataTable dt = new DataTable();
            try
            {
                using (SqlConnection con = new SqlConnection(ConnectionString))
                {
                    ...
                    {
                        cmdTeachers.CommandType = CommandType.StoredProcedure;
                        cmdTeachers.CommandText = "GetAllSDValue";
                        cmdTeachers.Connection = con;
        ...
        public DataTable GetSprintVariable()
        {
            DataTable dt = new DataTable();
            try
            {
                using (SqlConnection con = new SqlConnection(ConnectionString))
                {
                    ...
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.CommandText = "GetSprintVariable";
                        cmd.Connection = con;
                        SqlDataAdapter da = new SqlDataAdapter(cmd);
                        da.Fill(dt);
                        return dt;
        ...
        public DataSet GetAllSprintAthletesSDVariableData(int LessonId)
        {
            DataSet ds = new DataSet();
            using (SqlConnection conn = new SqlConnection(ConnectionString))
            {
                using (SqlCommand cmd = conn.CreateCommand())
                {
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.Add("@LessonId", SqlDbType.Int).Value = LessonId;
                    cmd.CommandText = "GetAllSprintAND_SDValue";
                    cmd.Connection = conn;
                    SqlDataAdapter da = new SqlDataAdapter(cmd);
                    da.Fill(ds);
                    return ds;
