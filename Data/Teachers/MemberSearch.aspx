<%@ Page Language="C#" MasterPageFile="~/MasterPages/MasterPageMain.master" AutoEventWireup="true"
    CodeFile="MemberSearch.aspx.cs" Inherits="Teachers_MemberSearch" Title="SwingModel - Teachers Member Search" %>
        ...
        <asp:TableRow>
            <asp:TableCell Width="500px" HorizontalAlign="Center">
                <p style="text-align: justify; width: 450px;">
                    Enter the name or initials of any of your Athletes that you would like to find.
                    A minimum of the first letter of each name is required. You may use an asterisk
                    (*) a wildcard to list all Athletes in the First Name and/or Last Name category.</p>
                ...
                <asp:TextBox CssClass="textBox" ID="TextBox2" runat="server" Width="220px"></asp:TextBox>
