...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="centeronpage" class="centeronpage">
        <p style="text-align: justify; width: 800px;">
            Enter a beginning date in the left hand date field and an ending date in the right
            hand date field. The search will locate all of your Members created during the specified
            date range.</p>
        <asp:DropDownList ID="DropDownList2" runat="server" Width="200px" Visible="False">
        </asp:DropDownList>
        <br />
