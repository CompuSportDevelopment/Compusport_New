<%@ Page Title="CompuSport – Coach Athlete Relay Data" Language="C#" MasterPageFile="~/MasterPages/MasterPageMain.master" AutoEventWireup="true" CodeFile="CoachAthleteRelayData.aspx.cs" Inherits="Teachers_CoachAthleteRelayData" %>
...
<script type="text/javascript" src="http://code.jquery.com/ui/1.10.3/jquery-ui.js"></script>
 ...
 <script type="text/javascript" >
     ...
     function NameValidate() {
         ...
         // Mouse Over Function relaydiv
         $(function () {
             $('#<%=Label1.ClientID%>').mouseover(function () {
                 $("#relaydiv").load('../VariablePages/TheRelay.aspx');
                 //$("#relaydiv").dialog().siblings('.ui-dialog-titlebar').remove();
                 $("#relaydiv").dialog({
                     width: 820,
             ...
             //MOuse over functon For passcompletdiv
             $(function () {
                 $('#<%=Label2.ClientID%>').mouseover(function () {
                     $("#passcompletdiv").load('../VariablePages/ThePassCompletionPosition.aspx');
                     //$("#relaydiv").dialog().siblings('.ui-dialog-titlebar').remove();
                     $("#passcompletdiv").dialog({
                         width: 820,
             ...
             //Mouse Over passtimediv
             $(function () {
                 $('#<%=Label3.ClientID%>').mouseover(function () {
                     $("#passtimediv").load('../VariablePages/ThePassTimeQuality.aspx');
                     //$("#relaydiv").dialog().siblings('.ui-dialog-titlebar').remove();
                     $("#passtimediv").dialog({
                         width: 820,
             ...
             $(function() {
                 ...
                 $("#passtimesdiv").load('../VariablePages/ThePassTimeQuality.aspx');
                     //$("#relaydiv").dialog().siblings('.ui-dialog-titlebar').remove();
                     $("#passtimesdiv").dialog({
                         width: 830,
                         height: 340,
             ...
             //MouseOver Event incomingdiv
             $(function () {
                 $('#<%=incominglabel.ClientID%>').mouseover(function () {
                     $("#incomingdiv").load('../VariablePages/TheIncoming.aspx');
                     //$("#relaydiv").dialog().siblings('.ui-dialog-titlebar').remove();
                     $("#incomingdiv").dialog({
                         width: 820,
             ...
             //MouseOver Event outgoingdiv
             $(function () {
                 $('#<%=outgoinglabel.ClientID%>').mouseover(function () {
                     $("#outgoingdiv").load('../VariablePages/TheOutgoing.aspx');
                     //$("#relaydiv").dialog().siblings('.ui-dialog-titlebar').remove();
                     $("#outgoingdiv").dialog({
                         width: 820,
             ...
             //MouseOver Event golinediv
             $(function () {
                 $('#<%=golinelabel.ClientID%>').mouseover(function () {
                     $("#golinediv").load('../VariablePages/TheGoLine.aspx');
                     //$("#relaydiv").dialog().siblings('.ui-dialog-titlebar').remove();
                     $("#golinediv").dialog({
                         width: 820,
