<%@ Page Language="C#" MasterPageFile="~/MasterPages/MasterPageMain.master" AutoEventWireup="true"
    CodeFile="TeacherBio.aspx.cs" Inherits="Teachers_TeacherBio" Title="CompuSport – My Coach Profile"
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <%-- <asp:Button ID="Button1" runat="server" Text="Submit" onclick="Button1_Click" Width="102px" />--%>&nbsp;&nbsp;
    &nbsp;&nbsp;
    <br />
    ...
    <div id="div2" style="position: fixed; background-color: #000000; display: none;
        opacity: 0.7; filter: alpha(opacity=70); left: 0px; top: 0px; right: 0px; bottom: 0px;
        z-index: 1000;">
    </div>
</asp:Content>
