<%@ Page Language="C#" MasterPageFile="~/MasterPages/MasterPageMain.master" AutoEventWireup="true" CodeFile="PayRenewal.aspx.cs" Inherits="Shop_PayRenewal" Title="SwingModel - Renew My SwingModel" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <p class="pagetitle">&nbsp;</p>
    <p class="pagetitle">Renew My SwingModel Account</p>
    ...
    <div style="float: left; width: 350px; text-align: justify;">
        <br />
        Your SwingModel account has expired. Please use the form to the left to renew your membership.
        <br /><br />
        If you feel that your account should not be expired, please send an email to
        <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="mailto:dev@swingmodel.com">dev@swingmodel.com</asp:HyperLink>.
        <br /><br /><br />
        <div style="text-align: center;">
            <asp:Image ID="Image1" runat="server" ImageUrl="~/Images/starterssl-ssl-secure.gif" /> 
        </div>
        <br />
        Your SwingModel annual membership provides unlimited access to the SwingModel teaching system
        and website.
        <br /><br />
        <div style="text-align: center;">
            <asp:Label ID="Label17" runat="server" Text="Annual Membership Fee:" Font-Bold="True"></asp:Label>
            <asp:Label ID="Label18" runat="server" Text=""></asp:Label>
        </div>
    </div>
    <br /><br />
    <div class="centeronpage" id="centeronpage" style="width: 100%;">
        <br />
