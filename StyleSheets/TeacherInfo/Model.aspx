<%@ Page Language="C#" MasterPageFile="~/MasterPages/MasterPageMain.master" AutoEventWireup="true" CodeFile="Model.aspx.cs" Inherits="TeacherInfo_Model" Title="SwingModel - The New 21st Century Super Model" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <p>
        As a teacher, you can imagine taking this Driver Model, or the Model for any club in the bag,
        and having it adjusted to the exact body dimensions and swing speed of your students.  You no
        longer have to wonder what you need to do to maximize their performance; it is shown right
        before your eyes.</p>
    <p class="pagetitle" style="width: 100%;">
        <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/TeacherInfo/System.aspx">Continue Tour</asp:HyperLink>
        or
