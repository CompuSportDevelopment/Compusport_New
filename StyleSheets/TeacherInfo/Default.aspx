<%@ Page Language="C#" MasterPageFile="~/MasterPages/MasterPageMain.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="TeacherInfo_Default" Title="SwingModel - About SwingModel" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <p class="pagetitle">Teacher Tour</p>
    <p>
        <div class="centeronpage" id="centeronpage">
            <span style="font-family: Magneto; font-size: large">Join Our Teaching Community:</span>
            <span style="font-size: large"> 
                <asp:HyperLink ID="HyperLink10" runat="server" NavigateUrl="mailto:rmann@swingmodel.com?subject=Teaching%20Info%20Inquiry">Request</asp:HyperLink>
                a contact from a SwingModel representative now.<br /><br />
            </span>
        </div>
    </p>
    --%>
    <div style="margin: 0px 0px 0px 0px; display: block; padding: 2px 0px 10px 0px; width: 930px; height: 620px; float: left;">
        <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,16,0"
            ...
            <param name="movie" value="http://www.swingmodel.com/Images/TeacherTour.swf">
            <param name="quality" value="high">
            <param name="play" value="true">
            <param name="loop" value="false">
            <param name="wmode" value="transparent">
            <embed id="WMP1" src="http://www.swingmodel.com/Images/TeacherTour.swf" width="930" height="610" play="true" loop="false"
