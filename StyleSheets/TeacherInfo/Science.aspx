<%@ Page Language="C#" MasterPageFile="~/MasterPages/MasterPageMain.master" AutoEventWireup="true" CodeFile="Science.aspx.cs" Inherits="TeacherInfo_Science" Title="SwingModel - Science Based Technology" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <p class="pagetitle" style="width: 100%;">
        <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/TeacherInfo/Process.aspx">Continue Tour</asp:HyperLink>
        or
