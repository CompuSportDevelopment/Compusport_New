<%@ Page Language="C#" MasterPageFile="~/MasterPages/MasterPageMain.master" AutoEventWireup="true"
    CodeFile="MemberList.aspx.cs" Inherits="Teachers_MemberList" Title="CompuSport – Facility Athlete List" %>
...
<script language="javascript" type="text/javascript">
    ...
    <div id="centeronpage" class="centeronpage">
        <p style="text-align: justify; width: 800px;">
            Select the Coach to view all of their Athletes. Teacher Type indicates whether they
            are the Athlete’s Primary (1) or Secondary (2) coach. Secondary coaches can be either
            currently involved with the athlete (but not the main coach), or were the Athlete’s
            coach in the past (and are still granted access to their results). The Tier level
            of the athlete indicates the USATF designated performance level of the Athlete,
            with 1 being highest and 5 being lowest. If the Athlete’s level is listed as zero
            (0), then the Athlete is either retired, or their results are otherwise unavailable.
        </p>
        <p style="text-align: justify; width: 800px;">
            If any of the listed Athletes are not associated with the coach, or you feel any
            of the Athlete’s information is incorrect, send an email to <a href="mailto:dev@compusport.com?subject=My Athlete List Issue"
            ...
            <ContentTemplate>
                <asp:GridView ID="GridView1" AutoGenerateColumns="false" runat="server">
                    <Columns>
                        ...
                        <asp:BoundField ItemStyle-Width="140" DataField="TeacherType" HeaderText="TeacherType" />
