<%@ Page Language="C#" MasterPageFile="~/MasterPages/MasterPageMain.master" AutoEventWireup="true" CodeFile="Research.aspx.cs" Inherits="About_Research" Title="SwingModel - SwingModel Equipment Research Effort" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <p class="pagetitle" style="width: 100%;">
        <asp:HyperLink ID="HyperLink7" runat="server" NavigateUrl="~/About/EquipmentFitting.aspx">Continue Tour</asp:HyperLink>
        or
        <asp:HyperLink ID="HyperLink8" runat="server" NavigateUrl="~/About/Default.aspx">Return to Golfer Tour Home</asp:HyperLink></p>
</asp:Content>
