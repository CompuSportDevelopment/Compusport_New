<%@ Page Language="C#" MasterPageFile="~/MasterPages/MasterPageMain.master" AutoEventWireup="true" CodeFile="Process.aspx.cs" Inherits="About_Process" Title="CompuSport - Modeling Techniques" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <p>
        As a golfer, this modeling technique can be used to show you how you, with your body size,
        can swing like the best players in the game.  Instead of trying to make you swing like a good
        player that cannot match your body size or swing speed, the SwingModel process can show you
        how to develop the best swing matched to your exact body dimensions and swing speed.</p>
    </div>
    <p class="pagetitle" style="width: 100%;">
        <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/About/GolfModeling.aspx">Continue Tour</asp:HyperLink>
        or
